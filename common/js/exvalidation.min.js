(function(a, b, c) {
	...
	d.prototype = {
		...
		basicValidate: function(b, c, d) {
			...
			n;
			for (n in g) if (e.hasClass(n) || n === "chkmin" && f.match(/(?:\s+|^)chkmin\d+(?:\s+|$)/) || n === "chkmax" && f.match(/(?:\s+|^)chkmax\d+(?:\s+|$)/) || f.indexOf(n) !== -1 && f.indexOf("chkretype") !== -1) if (typeof g[n][1] != "function") {
